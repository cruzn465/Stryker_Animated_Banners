...
function animate(){
    ...
    .to([legal_2x],.4,{opacity:0,ease:Quad.easeOut},"ef-=.6")
    ...
    .to(ef1_2x,.2,{ease:Quad.easeOut,width:0},"+=1")

    .from(ef2_2x,.4,{opacity:0,ease:Quad.easeOut,width:0},"+=.2")
    .from(ef3_2x,.4,{ease:Quad.easeOut,width:0},"+=.1")
    // .to(ef3_2x,.2,{opacity:0,ease:Quad.easeOut,width:0,x:dimensions.width/2},"efSwitch+=.5")
    .from(ef4_2x,.4,{opacity:0,ease:Quad.easeOut,width:0},"efSwitch+=.1")

    .from(cta_2x,.3,{opacity:0,ease:Quad.easeOut,width:0},"+=.4")
    .fromTo(sheen1,.7,{x:-200,ease:Quad.easeOut},{x:300,ease:Quad.easeIn},"+=.2")
